...
def IpTrafficAnalysis(client):
	...
	"""
	index = "netflow*"
	qDict = QueryBuilder().BuildDoubleAggregateQuery("src_addr", "dst_addr", "netflow.ipv4_src_addr", "netflow.ipv4_dst_addr", level1BucketType="terms", level2BucketType="terms", level1DocValueType="field", level2DocValueType="field",  size=0)
	...
	g = AggToNetworkGraph(aggDict, "src_addr", "dst_addr", labelVertices, labelEdges)
